...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'efun_app';
  ...
  'jhipster.mail.from' = 'efun_app@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'efun_app API';
  'jhipster.swagger.description' = 'efun_app API documentation';
  ...
  'eureka.instance.appname' = 'efun_app';
  'eureka.instance.instanceId' = 'efun_app:${random.value}';
